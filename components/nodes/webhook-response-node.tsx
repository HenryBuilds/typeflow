...
import { Send, CheckCircle2, XCircle, Loader2, Trash2, AlertCircle, Play } from "lucide-react";
    ...
    >
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <div className="font-bold text-sm">{data.label || "Webhook Response"}</div>
          {getStatusIcon()}
        </div>
          ...
          <div className="flex-1 overflow-auto">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">{data.label || "Webhook Response"}</p>
              </div>
              <div>
