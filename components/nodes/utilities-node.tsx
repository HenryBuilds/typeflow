...
import { Wrench, Play, CheckCircle2, XCircle, Loader2, Trash2, AlertCircle } from "lucide-react";
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <div className="font-bold text-sm">{data.label || "Utilities"}</div>
          {getStatusIcon()}
        </div>
          ...
          <div className="flex-1 overflow-auto">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">{data.label || "Utilities"}</p>
              </div>
              <div>
                <h4 className="text-sm font-semibold mb-2">Error Message:</h4>
                <pre className="text-xs font-mono bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded p-3 overflow-auto max-h-96 whitespace-pre-wrap wrap-break-word text-red-700 dark:text-red-400">
...
UtilitiesNode.displayName = "UtilitiesNode";
